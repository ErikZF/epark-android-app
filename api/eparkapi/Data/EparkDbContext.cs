...
public class EparkDbContext(DbContextOptions<EparkDbContext> options) : DbContext(options)
{
    ...
    public DbSet<SessionRate> SessionRates => Set<SessionRate>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SessionRate>().ToTable("session_rates");
        ...
        foreach (var name in new[] { "CreatedAt", "UpdatedAt", "IssuedAt", "ExtendedAt", "LockedAt" })
        {
            foreach (var entity in modelBuilder.Model.GetEntityTypes())
            {
